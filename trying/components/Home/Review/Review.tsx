      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-3 items-center gap-20">
        ...
        <div className="lg:col-span-1 mt-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl text-gray-800 font-semibold">Get In Touch With Us!</h1>
          </div>
          {/* title */}
          <h1 className="text-2xl md:text-3xl lg:text-4xl mt-8 font-bold md:leading-[1.7rem] lg:leading-[2.3rem] text-gray-900">
            Send Email or Call us Directly.
          </h1>
          <p className="text-base text-gray-800 text-opacity-60 mt-6">
        ...
        {/* Input */}
        <div className="lg:col-span-2 mt-6 overflow-hidden hidden md:block just__in">
          <Input />
        </div>
      </div>
    </div>
