    ...
    <div className="pt-16 pb-16" id="About">
      ...
      <div className="w-4/5 mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
        ...
        <div>
          ...
          <h1
            data-aos="fade-right"
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-8 font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[3.5rem] text-gray-800"
          >
            Ships all over India via Land Routes.
          </h1>
          <p data-aos="fade-right" data-aos-delay="200" className="mt-4 text-gray-600">
        ...
        <div>
          <div>
            <h1
              data-aos="fade-up"
              className="text-7xl lg:text-9xl font-bold text-black text-opacity-5"
            >
              01
            </h1>
          ...
          <div className="mt-8 w-full">
            ...
            <div data-aos="fade-left" data-aos-delay="200" className="-mt-10">
              <h1 className="text-xl md:text-2xl text-opacity-70 mb-3 text-black font-bold">
                Easy Transport
              </h1>
              <p className="w-[90%] lg:w-0[70%] text-base text-black text-opacity-60">
